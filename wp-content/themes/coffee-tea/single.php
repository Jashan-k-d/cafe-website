...
<section class="blog-area inarea-blog-single-page-two">
	<div class="container">
		<div class="row">
            <?php 
                $coffee_tea_single_post_sidebar_setting = get_theme_mod('coffee_tea_single_post_sidebar_setting','1');
                $coffee_tea_sidebar_position = get_theme_mod('coffee_tea_sidebar_position', 'right');
                $coffee_tea_content_class = ($coffee_tea_single_post_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $coffee_tea_single_post_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
