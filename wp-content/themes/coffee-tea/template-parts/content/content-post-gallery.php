...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
    <?php
        ...
        $coffee_tea_post_id = get_the_ID(); // Add this line to get the post ID
        $coffee_tea_gallery_shortcode = get_post_gallery();

        if (!empty($coffee_tea_gallery_shortcode)) {
            // Display the gallery
            echo '<div class="embedded-gallery">' . do_shortcode($coffee_tea_gallery_shortcode) . '</div>';
        }
    ?>
