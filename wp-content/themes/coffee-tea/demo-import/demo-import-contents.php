...
class Whizzie {
				...
				<div class="demo_content_image">
					...
					<div class="demo_image">
						<div class="demo_image buttons">
							<a href="<?php echo esc_url( COFFEE_TEA_PRO_THEME_URL ); ?>" class="button button-primary bundle" target="_blank"><?php echo esc_html__( 'Buy Now', 'coffee-tea' ); ?></a>
							<a href="<?php echo esc_url( COFFEE_TEA_THEME_BUNDLE_URL ); ?>" class="button button-primary bundle pro" target="_blank"><?php echo esc_html__( 'Buy All Themes', 'coffee-tea' ); ?></a>
							<a href="<?php echo esc_url( COFFEE_TEA_FREE_DOC_URL ); ?>" target="_blank" class="button button-primary"><?php echo esc_html__( 'Free Documentation', 'coffee-tea' ); ?></a>
						...
						<img src="<?php echo esc_url( get_template_directory_uri() . '/screenshot.png' ); ?>" alt="<?php echo esc_attr( $coffee_tea_theme_title ); ?>" />
					</div> <!-- .demo_image -->
	...
	public function setup_widgets(){
		...
		foreach ( $supermarket_shopping_product_category as $supermarket_shopping_product_cats => $supermarket_shopping_products_name ) {
			...
			$supermarket_shopping_image_name= 'services'.$k.'.png';
