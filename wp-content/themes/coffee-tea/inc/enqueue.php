...
function coffee_tea_scripts() {
	...
	$coffee_tea_slider_setting = get_theme_mod( 'coffee_tea_slider_setting', '1');
...
function coffee_tea_admin_enqueue_scripts(){
	wp_enqueue_style('coffee-tea-admin-style', esc_url( get_template_directory_uri() ) . '/inc/aboutthemes/admin.css');
	wp_enqueue_script('coffee-tea-dismiss-notice-script', get_stylesheet_directory_uri() . '/inc/aboutthemes/theme-admin-notice.js', array('jquery'), null, true);
}
add_action( 'admin_enqueue_scripts', 'coffee_tea_admin_enqueue_scripts' );