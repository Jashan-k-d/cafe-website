...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	$wp_customize->add_panel(
		'coffee_tea_general', array(
			'priority' => 31,
			'title' => esc_html__( 'General', 'coffee-tea' ),
		)
	);
	...
	$wp_customize->add_section(
		'coffee_tea_breadcrumb_setting', array(
			'title' => esc_html__( 'Breadcrumb Section', 'coffee-tea' ),
			'priority' => 1,
	...
	$wp_customize->add_section(
		'coffee_tea_preloader_section_setting', array(
			'title' => esc_html__( 'Preloader', 'coffee-tea' ),
			'priority' => 3,
			'panel' => 'coffee_tea_general',
		)
	);
	...
	$wp_customize->add_section(
		'coffee_tea_scroll_to_top_section_setting', array(
			'title' => esc_html__( 'Scroll To Top', 'coffee-tea' ),
			'priority' => 3,
			'panel' => 'coffee_tea_general',
		)
	);
	...
	$wp_customize->add_setting( 'coffee_tea_upgrade_page_settings_8',
        array(
            'sanitize_callback' => 'sanitize_text_field'
        )
    );
    $wp_customize->add_control( new Coffee_Tea_Control_Upgrade(
        $wp_customize, 'coffee_tea_upgrade_page_settings_8',
            array(
                'priority'      => 200,
                'section'       => 'coffee_tea_woocommerce_section_setting',
                'settings'      => 'coffee_tea_upgrade_page_settings_8',
                'label'         => __( 'Coffee Tea Pro comes with additional features.', 'coffee-tea' ),
                'choices'       => array( __( '12+ Sections', 'coffee-tea' ), __( 'One Click Demo Importer', 'coffee-tea' ), __( 'Section Reordering Facility', 'coffee-tea' ),__( 'Advance Typography', 'coffee-tea' ),__( 'Easy Customization', 'coffee-tea' ),__( '24x7 Support', 'coffee-tea' ), )
            )
        )
	...
	$wp_customize->add_section(
		'sticky_header_section_setting', array(
			'title' => esc_html__( 'Sticky Header Settings', 'coffee-tea' ),
			'priority' => 3,
			'panel' => 'coffee_tea_general',
		)
	);
	...
	$wp_customize->add_section(
		'coffee_tea_404_section', array(
			'title' => esc_html__( '404 Section', 'coffee-tea' ),
			'priority' => 1,
			'panel' => 'coffee_tea_general',
		)
	);
